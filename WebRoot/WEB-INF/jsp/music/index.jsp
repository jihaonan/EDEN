...
<body class="">
  <section class="vbox">
        ...
        <ul class="nav navbar-nav m-n hidden-xs nav-user user">
                ...
                <div class="list-group list-group-alt">
                  <a href="#" class="media list-group-item">
                    <span class="pull-left thumb-sm">
                      <img src="${pageContext.request.contextPath }/static/music/images/a0.png" alt="..." class="img-circle">
                    </span>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown">
              ...
              <!-- 头像，如果没有，有一个默认的 -->
               <c:if test="${currentuser.avatars !=null}">
              	<img src="${currentuser.avatars.url}" alt="...">
              </c:if>
              <c:if test="${currentuser.avatars ==null}">
              	<img src="${pageContext.request.contextPath }/static/music/images/a0.png" alt="..."> 
              </c:if>
     	 ...
     	 <ul class="nav navbar-nav  nav-user user">
     	 	<a href="${pageContext.request.contextPath }/user/login" class="ropdown-toggle bg clear">Signin</a>
     	 </ul>
    ...
    <section>
      <section class="hbox stretch">
              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="index.html" data-target="#content" data-el="#content_ch" data-replace="true">
                    ...
                    <li>
                      <a href="listen.html" data-target="#content" data-el="#content_ch" data-replace="true">
                  ...
                  <ul class="nav" data-ride="collapse">
                    ...
                    <li >
                      ...
                      <ul class="nav dk text-sm">
                        <li >
                          <a href="profile.html" class="auto" data-target="#content" data-url="#content section" data-replace="true">
                            <i class="fa fa-angle-right text-xs"></i>
        ...
        <!-- /.aside -->
        <section id="content" >
          <section class="hbox stretch" id="content_ch">

              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  <a href="#" class="pull-right text-muted m-t-lg" data-toggle="class:fa-spin" id="refresh"><i class="icon-refresh i-lg  inline" ></i></a>
                  ...
                  <div class="row row-sm" id="mydiscover">
                  
                  <!-- 这是其中一个比较完整的，以它为模板生成其它 -->
                  <c:forEach items="${discover}" var="item" varStatus="status">
                      ...
                      <div class="item">
                        ...
                        <!-- 歌曲时间，现在用默认的 -->
                          ...
                          <!-- 歌曲星级 -->
                            ...
                            <c:forEach var="x" begin="1" end="${item.star_num}" step="1"> 
								<i class="fa fa-star"></i>
							</c:forEach> 

 							<c:forEach var="x" begin="1" end="${5-item.star_num}" step="1"> 
								<i class="fa fa-star-o text-muted"></i>
							</c:forEach>                        
                            </div>
                            <div class="center text-center m-t-n">
                              <a href="javascript:void(0);" data-toggle="class" class="jp-play-discover" data-music_url="${item.mp3 }">
                          ...
                          <a href="#"><img src="${item.poster}" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                          <a href="#" class="text-ellipsis">${item.title }</a>
                          <a href="#" class="text-ellipsis text-xs text-muted">${item.artist }</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      ...
                      <c:forEach items="${newsongs }" var="item" varStatus="status">
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              <div class="item-overlay opacity r r-2x bg-black">
                                <div class="center text-center m-t-n">
                                  <a href="#" class="jp-play-newsongs" data-music_url="${item.mp3 }"><i class="fa fa-play-circle i-2x"></i></a>
                                </div>
                              </div>
                              <a href="#"><img src="${item.artistImg }" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                              <a href="#" class="text-ellipsis">${item.title }</a>
                              <a href="#" class="text-ellipsis text-xs text-muted">${item.artist }</a>
                    ...
                    <div class="col-md-5">
                      ...
                      <c:forEach items="${top}" var="item" varStatus="status">                
                        <a href="#" class="jp-play-topsongs list-group-item clearfix" data-music_url="${item.mp3 }">
                          <span class="pull-right h2 text-muted m-l">${item.rank}</span>
                          <span class="pull-left thumb-sm avatar m-r">
                            <img src="${item.artistImg}" alt="...">
                          </span>
                          <span class="clear">
                            <span>${item.title }</span>
                            <small class="text-muted clear text-ellipsis">by ${item.artist }</small>
                          </span>
                        </a>
                       </c:forEach> 
                  ...
                  <ul class="list-group no-bg no-borders auto m-t-n-xxs">
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a1.png" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a2.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a3.png" alt="...">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a4.png" alt="...">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a5.png" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a6.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Amanda Conlan</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a7.png" alt="...">
                        <i class="busy b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Dan Doorack</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a8.png" alt="...">
                        <i class="away b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Lauren Taylor</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a9.png" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="${pageContext.request.contextPath }/static/music/images/a1.png" alt="...">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Amanda Conlan</a></div>
    ...
    <footer class=" bg-black navbar-fixed-bottom">
  ...
  <script src="${pageContext.request.contextPath }/static/music/js/jquery.min.js"></script>
    <script src="${pageContext.request.contextPath }/static/music/js/jquery-jtemplates.js"></script>
  <!-- Bootstrap -->
...
var topsonglist=${topsonglist};
var newsonglist=${newsonglist};
