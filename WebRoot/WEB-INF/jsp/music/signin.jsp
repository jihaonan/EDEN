  ...
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
      ...
      <section class="m-b-lg">
        ...
        <form action="${pageContext.request.contextPath }/user/login_submit" method="post">
          ...
          <a href="${pageContext.request.contextPath }/user/register" class="btn btn-lg btn-info btn-block rounded">Create an account</a>
        </form>
      </section>
    </div>
  </section>
