...
<section class="vbox">
  ...
  <section>
    <section class="hbox stretch">
      ...
      <!-- /.aside -->
      <section id="content">
        <section class="vbox" id="content_ch">
                    ...
                    <ul class="list-group list-group-lg no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                      <li class="list-group-item">
                        <div class="pull-right m-l">
                          ...
                          <a href="javascript:void(0);" class="m-r-sm"><i class="icon-plus"></i></a>
                          <a href="javascript:void(0);"><i class="icon-close"></i></a>
                        </div>
                        <a href="javascript:void(0);" class="jp-play-me m-r-sm pull-left" data-music_url="http://127.0.0.1:8080/sources/music/沢井美空 - 卒业メモリーズ~サヨナラ、あなた.~.mp3">
                      ...
                      <li class="list-group-item">
                        ...
                        <a href="javascript:void(0);" class="jp-play-me m-r-sm pull-left" data-music_url="http://127.0.0.1:8080/sources/music/Tassel - Cymophane  .mp3">
                          <i class="icon-control-play text"></i>
                          <i class="icon-control-pause text-active"></i>
                        </a>
                        <div class="clear text-ellipsis">
  ...
  <script type="text/javascript" src="js/jPlayer/my_player.js"></script>
